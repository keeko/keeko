...
use net::keeko::cms::core::entities::Menu;
...
abstract class BaseMenuPeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.Menu';
	...
	private static $fieldNames = array (
		::BasePeer::TYPE_PHPNAME => array ('Id', 'UnitId', 'BlockId', 'Name', 'IsAdmin', ),
		::BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'unitId', 'blockId', 'name', 'isAdmin', ),
		::BasePeer::TYPE_COLNAME => array (self::ID, self::UNIT_ID, self::BLOCK_ID, self::NAME, self::IS_ADMIN, ),
		::BasePeer::TYPE_FIELDNAME => array ('id', 'unit_id', 'block_id', 'name', 'is_admin', ),
	...
	private static $fieldKeys = array (
		::BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UnitId' => 1, 'BlockId' => 2, 'Name' => 3, 'IsAdmin' => 4, ),
		::BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'unitId' => 1, 'blockId' => 2, 'name' => 3, 'isAdmin' => 4, ),
		::BasePeer::TYPE_COLNAME => array (self::ID => 0, self::UNIT_ID => 1, self::BLOCK_ID => 2, self::NAME => 3, self::IS_ADMIN => 4, ),
		::BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'unit_id' => 1, 'block_id' => 2, 'name' => 3, 'is_admin' => 4, ),
		::BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(::Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MenuPeer::UNIT_ID);

		$criteria->addSelectColumn(MenuPeer::BLOCK_ID);

		$criteria->addSelectColumn(MenuPeer::NAME);

		$criteria->addSelectColumn(MenuPeer::IS_ADMIN);
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$stmt = MenuPeer::doSelectStmt($criteria, $con);
	...
	public static function doCountJoinBlock(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(MenuPeer::BLOCK_ID, BlockPeer::ID, ::Criteria::LEFT_JOIN);
	...
	public static function doCountJoinUnit(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(MenuPeer::UNIT_ID, UnitPeer::ID, ::Criteria::LEFT_JOIN);
	...
	/**
	 * Selects a collection of Menu objects pre-filled with their Block objects.
	 *
	...
	public static function doSelectJoinBlock(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(MenuPeer::BLOCK_ID, BlockPeer::ID, ::Criteria::LEFT_JOIN);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Menu) to $obj2 (Block)
				$obj2->addMenu($obj1);
	...
	/**
	 * Selects a collection of Menu objects pre-filled with their Unit objects.
	 *
	 * @return     array Array of Menu objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	public static function doSelectJoinUnit(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(MenuPeer::UNIT_ID, UnitPeer::ID, ::Criteria::LEFT_JOIN);
		$stmt = ::BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Menu) to $obj2 (Unit)
				$obj2->addMenu($obj1);
	...
	public static function doSelectJoinAll(::Criteria $c, $con = null)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Menu) to the collection in $obj2 (Block)
				$obj2->addMenu($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Menu) to the collection in $obj3 (Unit)
				$obj3->addMenu($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Menu objects pre-filled with all related objects except Block.
	 *
	 * @return     array Array of Menu objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	public static function doSelectJoinAllExceptBlock(::Criteria $c, $con = null)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = MenuPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== (MenuPeer::getInstanceFromPool($key1))) {
				$obj1->hydrate($row, 0, true); // rehydrate
			} else {
				$omClass = MenuPeer::getOMClass();
				...
				// Add the $obj1 (Menu) to the collection in $obj2 (Unit)
				$obj2->addMenu($obj1);
	...
	/**
	 * Selects a collection of Menu objects pre-filled with all related objects except Unit.
	 *
	 * @return     array Array of Menu objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
