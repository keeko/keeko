...
/**
 * Base class that represents a row from the 'param' table.
 *
 * 
 *
 * @package    net.keeko.cms.core.entities.om
 */
abstract class BaseParam extends ::BaseObject  implements ::Persistent {
	...
	/**
	 * @var        array UnitAction[] Collection to store aggregation of UnitAction objects.
	 */
	...
	/**
	 * Initializes internal state of BaseParam object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Param The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ParamPeer::ID;
		}
	...
	public function setKeyname($v)
	{
		...
		if ($this->keyname !== $v) {
			$this->keyname = $v;
			$this->modifiedColumns[] = ParamPeer::KEYNAME;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = ParamPeer::VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ParamPeer::NUM_COLUMNS - ParamPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new ::PropelException("Error populating Param object", $e);
		}
	}
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		$stmt = ParamPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(::PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			ParamPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (::PropelException $e) {
			$con->rollback();
			throw $e;
	...
	protected function doSave(::PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ParamPeer::doInsert($this, $con);
					...
					$affectedRows += ParamPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ParamPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ParamPeer::translateFieldName($name, $type, ::BasePeer::TYPE_NUM);
	...
	{
		$keys = ParamPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ParamPeer::ID)) $criteria->add(ParamPeer::ID, $this->id);
		if ($this->isColumnModified(ParamPeer::KEYNAME)) $criteria->add(ParamPeer::KEYNAME, $this->keyname);
		if ($this->isColumnModified(ParamPeer::VALUE)) $criteria->add(ParamPeer::VALUE, $this->value);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ParamPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Param (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Param Clone of current object.
	 * @throws     ::PropelException
	 */
	...
	{
		if (self::$peer === null) {
			self::$peer = new ParamPeer();
		}
		return self::$peer;
	}

	/**
	 * Temporary storage of collUnitActions to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 *
	 * @return     void
	 * @deprecated - This method will be removed in 2.0 since arrays
	 *				are automatically initialized in the addUnitActions() method.
	 * @see        addUnitActions()
	 */
	 ...
	 * Otherwise if this Param has previously been saved, it will retrieve
	 * related UnitActions from storage. If this Param is new, it will return
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
			   $this->collUnitActions = array();
				...
				$criteria->add(UnitActionPeer::PARAM_ID, $this->getId());

				UnitActionPeer::addSelectColumns($criteria);
				$this->collUnitActions = UnitActionPeer::doSelect($criteria, $con);
			}
		} else {
	...
	/**
	 * Returns the number of related UnitActions.
	 *
	 * @param      ::Criteria $criteria
	...
	public function countUnitActions(::Criteria $criteria = null, $distinct = false, ::PropelPDO $con = null)
	{
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
				...
				$count = UnitActionPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a UnitAction object to this object
	 * through the UnitAction foreign key attribute.
	 *
	 * @param      UnitAction $l UnitAction
	 * @return     void
	 * @throws     ::PropelException
	 */
	public function addUnitAction(UnitAction $l)
	{
		if ($this->collUnitActions === null) {
			$this->collUnitActions = array();
		}
	 ...
	 * Otherwise if this Param is new, it will return
	 * an empty collection; or if this Param has previously
	 * been saved, it will retrieve related UnitActions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Param.
	 */
	public function getUnitActionsJoinUnit($criteria = null, $con = null)
	{
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
				...
				$this->collUnitActions = UnitActionPeer::doSelectJoinUnit($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in Param.
	 */
	public function getUnitActionsJoinAction($criteria = null, $con = null)
	{
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
				...
				$this->collUnitActions = UnitActionPeer::doSelectJoinAction($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical ::Criteria, it returns the collection.
	 * Otherwise if this Param has previously been saved, it will retrieve
	 * related BlockActions from storage. If this Param is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      ::PropelPDO $con
	 * @param      ::Criteria $criteria
		...
		if ($this->collBlockActions === null) {
			if ($this->isNew()) {
			   $this->collBlockActions = array();
				...
				$criteria->add(BlockActionPeer::PARAM_ID, $this->getId());
	 ...
	 * actually need in Param.
	 */
	public function getBlockActionsJoinBlock($criteria = null, $con = null)
	{
		...
		if ($this->collBlockActions === null) {
			if ($this->isNew()) {
				...
				$this->collBlockActions = BlockActionPeer::doSelectJoinBlock($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
