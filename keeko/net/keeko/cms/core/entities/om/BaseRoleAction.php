...
abstract class BaseRoleAction extends ::BaseObject  implements ::Persistent {
	...
	/**
	 * Initializes internal state of BaseRoleAction object.
	 * @see        applyDefaults()
	 */
	...
	public function setActionId($v)
	{
		...
		if ($this->action_id !== $v) {
			$this->action_id = $v;
			$this->modifiedColumns[] = RoleActionPeer::ACTION_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = RoleActionPeer::NUM_COLUMNS - RoleActionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		$stmt = RoleActionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(::PropelPDO $con = null)
	{
		...
		try {
			...
			RoleActionPeer::doDelete($this, $con);
	...
	public function save(::PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			RoleActionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (::PropelException $e) {
			$con->rollback();
			throw $e;
	...
	protected function doSave(::PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RoleActionPeer::doInsert($this, $con);
					...
					$affectedRows += RoleActionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RoleActionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RoleActionPeer::translateFieldName($name, $type, ::BasePeer::TYPE_NUM);
	...
	{
		$keys = RoleActionPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RoleActionPeer::ACTION_ID)) $criteria->add(RoleActionPeer::ACTION_ID, $this->action_id);
		if ($this->isColumnModified(RoleActionPeer::ROLE_ID)) $criteria->add(RoleActionPeer::ROLE_ID, $this->role_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RoleActionPeer::ACTION_ID, $this->action_id);
		$criteria->add(RoleActionPeer::ROLE_ID, $this->role_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RoleAction (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RoleAction Clone of current object.
	 * @throws     ::PropelException
	 */
	 ...
	 *
	 * @return     RoleActionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RoleActionPeer();
		}
		return self::$peer;
	}
