...
use net::keeko::cms::core::entities::map::ActionMapBuilder;
...
use net::keeko::cms::core::entities::Action;
...
abstract class BaseActionPeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.Action';
	...
	const COUNT = 'COUNT(action.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT action.ID)';
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		if ($distinct || in_array(::Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(ActionPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(ActionPeer::COUNT);
		}
	...
	public static function doCountJoinModule(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(ActionPeer::MODULE_ID, ModulePeer::ID, ::Criteria::LEFT_JOIN);
	...
	public static function doSelectJoinModule(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(ActionPeer::MODULE_ID, ModulePeer::ID, ::Criteria::LEFT_JOIN);
	...
	public static function doInsert($values, ::PropelPDO $con = null)
	{
		...
		$criteria->remove(ActionPeer::ID); // remove pkey col since this table uses auto-increment
