...
class UserSettingValueMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.UserSettingValueMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(UserSettingValuePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(UserSettingValuePeer::TABLE_NAME);
		$tMap->setPhpName('UserSettingValue');
		$tMap->setClassname('UserSettingValue');
