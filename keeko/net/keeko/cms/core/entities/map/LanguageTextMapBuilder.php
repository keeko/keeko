...
class LanguageTextMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.LanguageTextMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(LanguageTextPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(LanguageTextPeer::TABLE_NAME);
		$tMap->setPhpName('LanguageText');
		$tMap->setClassname('LanguageText');
