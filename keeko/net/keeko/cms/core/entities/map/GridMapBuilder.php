...
class GridMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.GridMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(GridPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(GridPeer::TABLE_NAME);
		$tMap->setPhpName('Grid');
		$tMap->setClassname('Grid');
		...
		$tMap->addForeignKey('LAYOUT_ID', 'LayoutId', 'INTEGER', 'layout', 'ID', false, 10);
