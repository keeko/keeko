...
class LanguageMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.LanguageMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(LanguagePeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(LanguagePeer::TABLE_NAME);
		$tMap->setPhpName('Language');
		$tMap->setClassname('Language');
