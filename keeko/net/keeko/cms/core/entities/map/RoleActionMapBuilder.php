...
class RoleActionMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.RoleActionMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(RoleActionPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(RoleActionPeer::TABLE_NAME);
		$tMap->setPhpName('RoleAction');
		$tMap->setClassname('RoleAction');
