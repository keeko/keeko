...
use net\keeko\cms\core\entities\Module;
	...
	/**	 * Loads an action of this module. Processes checks wether the current user is	 * allowed to load this action.	 *	 * @param string action The actions name. The passed parameter is the name in i18n format. This parameter is translated into the ClassName of the desired action.	 * @return net\keeko\cms\core\AbstractAction	 * @access public	 */	public function loadAction($action) {
		$unixname = $this->entity->getUnixname();
