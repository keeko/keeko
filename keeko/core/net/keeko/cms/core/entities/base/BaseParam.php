...
abstract class BaseParam extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\ParamPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseParam object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     net\keeko\cms\core\entities\Param The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ParamPeer::ID;
		}
	...
	public function setKeyname($v)
	{
		...
		if ($this->keyname !== $v) {
			$this->keyname = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ParamPeer::KEYNAME;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ParamPeer::VALUE;
		}
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\ParamPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\ParamPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\ParamPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\ParamPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\ParamPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\ParamPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\ParamPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\ParamPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\ParamPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\ParamPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\ParamPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ParamPeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\ParamPeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ParamPeer::KEYNAME)) $criteria->add(\net\keeko\cms\core\entities\peer\ParamPeer::KEYNAME, $this->keyname);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ParamPeer::VALUE)) $criteria->add(\net\keeko\cms\core\entities\peer\ParamPeer::VALUE, $this->value);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Param (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Param Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\Param has previously been saved, it will retrieve
	 * related UnitActionParams from storage. If this net\keeko\cms\core\entities\Param is new, it will return
		...
		if ($this->collUnitActionParams === null) {
			if ($this->isNew()) {
			   $this->collUnitActionParams = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\UnitActionParamPeer::PARAM_ID, $this->id);
	 ...
	 */
	public function getUnitActionParamsJoinUnitAction($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\ParamPeer::DATABASE_NAME);
		}
		...
		if ($this->collUnitActionParams === null) {
			if ($this->isNew()) {
				...
				$this->collUnitActionParams = \net\keeko\cms\core\entities\peer\UnitActionParamPeer::doSelectJoinUnitAction($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseParam
