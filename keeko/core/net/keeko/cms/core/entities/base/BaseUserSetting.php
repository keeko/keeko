...
abstract class BaseUserSetting extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\UserSettingPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseUserSetting object.
	 * @see        applyDefaults()
	 */
	...
	public function setKeyname($v)
	{
		...
		if ($this->keyname !== $v) {
			$this->keyname = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UserSettingPeer::KEYNAME;
		}
	...
	public function setModuleId($v)
	{
		...
		if ($this->module_id !== $v) {
			$this->module_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UserSettingPeer::MODULE_ID;
		}
	...
	public function setFormat($v)
	{
		...
		if ($this->format !== $v) {
			$this->format = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UserSettingPeer::FORMAT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = \net\keeko\cms\core\entities\peer\UserSettingPeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\UserSettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UserSettingPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\UserSettingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UserSettingPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\UserSettingPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\UserSettingPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\UserSettingPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\UserSettingPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\UserSettingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\UserSettingPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\UserSettingPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UserSettingPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UserSettingPeer::KEYNAME)) $criteria->add(\net\keeko\cms\core\entities\peer\UserSettingPeer::KEYNAME, $this->keyname);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UserSettingPeer::MODULE_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\UserSettingPeer::MODULE_ID, $this->module_id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UserSettingPeer::FORMAT)) $criteria->add(\net\keeko\cms\core\entities\peer\UserSettingPeer::FORMAT, $this->format);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\UserSetting (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\UserSetting Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\UserSetting has previously been saved, it will retrieve
	 * related UserSettingValues from storage. If this net\keeko\cms\core\entities\UserSetting is new, it will return
	 ...
	 */
	public function getUserSettingValuesJoinUser($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UserSettingPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserSettingValues === null) {
			if ($this->isNew()) {
				...
				$this->collUserSettingValues = \net\keeko\cms\core\entities\peer\UserSettingValuePeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseUserSetting
