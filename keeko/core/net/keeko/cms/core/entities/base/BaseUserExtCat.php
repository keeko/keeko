...
abstract class BaseUserExtCat extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\UserExtCatPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseUserExtCat object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     net\keeko\cms\core\entities\UserExtCat The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UserExtCatPeer::ID;
		}
	...
	public function setTitleId($v)
	{
		...
		if ($this->title_id !== $v) {
			$this->title_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UserExtCatPeer::TITLE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = \net\keeko\cms\core\entities\peer\UserExtCatPeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\UserExtCatPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UserExtCatPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\UserExtCatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UserExtCatPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\UserExtCatPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\UserExtCatPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\UserExtCatPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\UserExtCatPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\UserExtCatPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\UserExtCatPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\UserExtCatPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UserExtCatPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UserExtCatPeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\UserExtCatPeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UserExtCatPeer::TITLE_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\UserExtCatPeer::TITLE_ID, $this->title_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\UserExtCat (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\UserExtCat Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\UserExtCat has previously been saved, it will retrieve
	 * related UserExts from storage. If this net\keeko\cms\core\entities\UserExtCat is new, it will return
		...
		if ($this->collUserExts === null) {
			if ($this->isNew()) {
			   $this->collUserExts = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\UserExtPeer::CAT_ID, $this->id);
	 ...
	 */
	public function getUserExtsJoinLanguageText($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UserExtCatPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserExts === null) {
			if ($this->isNew()) {
				...
				$this->collUserExts = \net\keeko\cms\core\entities\peer\UserExtPeer::doSelectJoinLanguageText($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseUserExtCat
