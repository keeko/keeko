...
abstract class BaseModule extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\ModulePeer
	 */
	...
	/**
	 * @var        array net\keeko\cms\core\entities\Setting[] Collection to store aggregation of net\keeko\cms\core\entities\Setting objects.
	 */
	...
	/**
	 * @var        array net\keeko\cms\core\entities\Action[] Collection to store aggregation of net\keeko\cms\core\entities\Action objects.
	 */
	...
	/**
	 * @var        array net\keeko\cms\core\entities\UserSetting[] Collection to store aggregation of net\keeko\cms\core\entities\UserSetting objects.
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseModule object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     net\keeko\cms\core\entities\Module The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ModulePeer::ID;
		}
	...
	public function setUnixname($v)
	{
		...
		if ($this->unixname !== $v) {
			$this->unixname = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ModulePeer::UNIXNAME;
		}
	...
	public function setVersion($v)
	{
		...
		if ($this->version !== $v) {
			$this->version = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\ModulePeer::VERSION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = \net\keeko\cms\core\entities\peer\ModulePeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\ModulePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\ModulePeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\ModulePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\ModulePeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\ModulePeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\ModulePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\ModulePeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\ModulePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\ModulePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\ModulePeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\ModulePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\ModulePeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ModulePeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\ModulePeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ModulePeer::UNIXNAME)) $criteria->add(\net\keeko\cms\core\entities\peer\ModulePeer::UNIXNAME, $this->unixname);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\ModulePeer::VERSION)) $criteria->add(\net\keeko\cms\core\entities\peer\ModulePeer::VERSION, $this->version);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Module (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Module Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Clears out the collSettings collection (array).
	 *
	...
	/**
	 * Initializes the collSettings collection (array).
	 *
	...
	/**
	 * Gets an array of net\keeko\cms\core\entities\Setting objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Module has previously been saved, it will retrieve
	 * related Settings from storage. If this net\keeko\cms\core\entities\Module is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array net\keeko\cms\core\entities\Setting[]
	 * @throws     PropelException
	 */
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
			   $this->collSettings = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::MODULE_ID, $this->id);

				\net\keeko\cms\core\entities\peer\SettingPeer::addSelectColumns($criteria);
				$this->collSettings = \net\keeko\cms\core\entities\peer\SettingPeer::doSelect($criteria, $con);
			}
		} else {
	...
	/**
	 * Returns the number of related net\keeko\cms\core\entities\Setting objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related net\keeko\cms\core\entities\Setting objects.
	 * @throws     PropelException
	 */
	public function countSettings(\Criteria $criteria = null, $distinct = false, \PropelPDO $con = null)
	{
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
				...
				$count = \net\keeko\cms\core\entities\peer\SettingPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a net\keeko\cms\core\entities\Setting object to this object
	 * through the net\keeko\cms\core\entities\Setting foreign key attribute.
	 *
	 * @param      net\keeko\cms\core\entities\Setting $l net\keeko\cms\core\entities\Setting
	 * @return     void
	 * @throws     PropelException
	 */
	 ...
	 */
	public function getSettingsJoinSettingSection($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\ModulePeer::DATABASE_NAME);
		}
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
				...
				$this->collSettings = \net\keeko\cms\core\entities\peer\SettingPeer::doSelectJoinSettingSection($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collActions collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collActions collection (array).
	 *
	...
	/**
	 * Gets an array of net\keeko\cms\core\entities\Action objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Module has previously been saved, it will retrieve
	 * related Actions from storage. If this net\keeko\cms\core\entities\Module is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array net\keeko\cms\core\entities\Action[]
	 * @throws     PropelException
	 */
		...
		if ($this->collActions === null) {
			if ($this->isNew()) {
			   $this->collActions = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\ActionPeer::MODULE_ID, $this->id);

				\net\keeko\cms\core\entities\peer\ActionPeer::addSelectColumns($criteria);
				$this->collActions = \net\keeko\cms\core\entities\peer\ActionPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Returns the number of related net\keeko\cms\core\entities\Action objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related net\keeko\cms\core\entities\Action objects.
	 * @throws     PropelException
	 */
	public function countActions(\Criteria $criteria = null, $distinct = false, \PropelPDO $con = null)
	{
		...
		if ($this->collActions === null) {
			if ($this->isNew()) {
				...
				$count = \net\keeko\cms\core\entities\peer\ActionPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a net\keeko\cms\core\entities\Action object to this object
	 * through the net\keeko\cms\core\entities\Action foreign key attribute.
	 *
	 * @param      net\keeko\cms\core\entities\Action $l net\keeko\cms\core\entities\Action
	 * @return     void
	 * @throws     PropelException
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Module has previously been saved, it will retrieve
	 * related MenuItems from storage. If this net\keeko\cms\core\entities\Module is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collMenuItems === null) {
			if ($this->isNew()) {
			   $this->collMenuItems = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\MenuItemPeer::MODULE_ID, $this->id);
	...
	/**
	 * Clears out the collUserSettings collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collUserSettings collection (array).
	 *
	...
	/**
	 * Gets an array of net\keeko\cms\core\entities\UserSetting objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Module has previously been saved, it will retrieve
	 * related UserSettings from storage. If this net\keeko\cms\core\entities\Module is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array net\keeko\cms\core\entities\UserSetting[]
	 * @throws     PropelException
	 */
		...
		if ($this->collUserSettings === null) {
			if ($this->isNew()) {
			   $this->collUserSettings = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\UserSettingPeer::MODULE_ID, $this->id);

				\net\keeko\cms\core\entities\peer\UserSettingPeer::addSelectColumns($criteria);
				$this->collUserSettings = \net\keeko\cms\core\entities\peer\UserSettingPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Returns the number of related net\keeko\cms\core\entities\UserSetting objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related net\keeko\cms\core\entities\UserSetting objects.
	 * @throws     PropelException
	 */
	public function countUserSettings(\Criteria $criteria = null, $distinct = false, \PropelPDO $con = null)
	{
		...
		if ($this->collUserSettings === null) {
			if ($this->isNew()) {
				...
				$count = \net\keeko\cms\core\entities\peer\UserSettingPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a net\keeko\cms\core\entities\UserSetting object to this object
	 * through the net\keeko\cms\core\entities\UserSetting foreign key attribute.
	 *
	 * @param      net\keeko\cms\core\entities\UserSetting $l net\keeko\cms\core\entities\UserSetting
	 * @return     void
	 * @throws     PropelException
	 */
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collSettings) {
				foreach ((array) $this->collSettings as $o) {
			...
			if ($this->collUserSettings) {
				foreach ((array) $this->collUserSettings as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
...
} // net\keeko\cms\core\entities\base\BaseModule
