...
abstract class BaseSetting extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\SettingPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseSetting object.
	 * @see        applyDefaults()
	 */
	...
	public function setKeyname($v)
	{
		...
		if ($this->keyname !== $v) {
			$this->keyname = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::KEYNAME;
		}
	...
	public function setSectionId($v)
	{
		...
		if ($this->section_id !== $v) {
			$this->section_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::SECTION_ID;
		}
	...
	public function setModuleId($v)
	{
		...
		if ($this->module_id !== $v) {
			$this->module_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::MODULE_ID;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::VALUE;
		}
	...
	public function setFormat($v)
	{
		...
		if ($this->format !== $v) {
			$this->format = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::FORMAT;
		}
	...
	public function setHide($v)
	{
		...
		if ($this->hide !== $v) {
			$this->hide = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingPeer::HIDE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->section_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			$this->hide = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = \net\keeko\cms\core\entities\peer\SettingPeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\SettingPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\SettingPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\SettingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\SettingPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\SettingPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\SettingPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\SettingPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\SettingPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\SettingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\SettingPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\SettingPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::KEYNAME)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::KEYNAME, $this->keyname);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::SECTION_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::SECTION_ID, $this->section_id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::MODULE_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::MODULE_ID, $this->module_id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::VALUE)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::VALUE, $this->value);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::FORMAT)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::FORMAT, $this->format);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingPeer::HIDE)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::HIDE, $this->hide);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Setting (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Setting Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a net\keeko\cms\core\entities\SettingSection object.
	 *
	 * @param      net\keeko\cms\core\entities\SettingSection $v
	 * @return     net\keeko\cms\core\entities\Setting The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setSettingSection(net\keeko\cms\core\entities\SettingSection $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the net\keeko\cms\core\entities\SettingSection object, it will not be re-added.
		if ($v !== null) {
			$v->addSetting($this);
		}
	...
	/**
	 * Get the associated net\keeko\cms\core\entities\SettingSection object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     net\keeko\cms\core\entities\SettingSection The associated net\keeko\cms\core\entities\SettingSection object.
	 * @throws     PropelException
	 */
	public function getSettingSection(\PropelPDO $con = null)
	{
		if ($this->aSettingSection === null && ($this->section_id !== null)) {
			$this->aSettingSection = \net\keeko\cms\core\entities\peer\SettingSectionPeer::retrieveByPK($this->section_id, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
...
} // net\keeko\cms\core\entities\base\BaseSetting
