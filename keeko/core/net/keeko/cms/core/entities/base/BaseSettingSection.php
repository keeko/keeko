...
abstract class BaseSettingSection extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\SettingSectionPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseSettingSection object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingSectionPeer::ID;
		}
	...
	public function setNameId($v)
	{
		...
		if ($this->name_id !== $v) {
			$this->name_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\SettingSectionPeer::NAME_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = \net\keeko\cms\core\entities\peer\SettingSectionPeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\SettingSectionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\SettingSectionPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\SettingSectionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\SettingSectionPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\SettingSectionPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\SettingSectionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\SettingSectionPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\SettingSectionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\SettingSectionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\SettingSectionPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\SettingSectionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\SettingSectionPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingSectionPeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingSectionPeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\SettingSectionPeer::NAME_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\SettingSectionPeer::NAME_ID, $this->name_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\SettingSection (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\SettingSection Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\SettingSection has previously been saved, it will retrieve
	 * related Settings from storage. If this net\keeko\cms\core\entities\SettingSection is new, it will return
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
			   $this->collSettings = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\SettingPeer::SECTION_ID, $this->id);
	 ...
	 */
	public function getSettingsJoinModule($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\SettingSectionPeer::DATABASE_NAME);
		}
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
				...
				$this->collSettings = \net\keeko\cms\core\entities\peer\SettingPeer::doSelectJoinModule($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseSettingSection
