...
abstract class BaseBlock extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\BlockPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseBlock object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     net\keeko\cms\core\entities\Block The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\BlockPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\BlockPeer::NAME;
		}
	...
	public function setIsContent($v)
	{
		...
		if ($this->is_content !== $v) {
			$this->is_content = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\BlockPeer::IS_CONTENT;
		}
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\BlockPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\BlockPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\BlockPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\BlockPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\BlockPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\BlockPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\BlockPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\BlockPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\BlockPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\BlockPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\BlockPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\BlockPeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\BlockPeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\BlockPeer::NAME)) $criteria->add(\net\keeko\cms\core\entities\peer\BlockPeer::NAME, $this->name);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\BlockPeer::IS_CONTENT)) $criteria->add(\net\keeko\cms\core\entities\peer\BlockPeer::IS_CONTENT, $this->is_content);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Block (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Block Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\Block has previously been saved, it will retrieve
	 * related Grids from storage. If this net\keeko\cms\core\entities\Block is new, it will return
		...
		if ($this->collGrids === null) {
			if ($this->isNew()) {
			   $this->collGrids = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\GridPeer::BLOCK_ID, $this->id);
	 ...
	 * actually need in Block.
	 */
	public function getGridsJoinPage($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\BlockPeer::DATABASE_NAME);
		}
...
} // net\keeko\cms\core\entities\base\BaseBlock
