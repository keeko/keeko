...
abstract class BaseRole extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\RolePeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseRole object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::USER_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::NAME;
		}
	...
	public function setIsGuest($v)
	{
		...
		if ($this->is_guest !== $v) {
			$this->is_guest = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::IS_GUEST;
		}
	...
	public function setIsDefault($v)
	{
		...
		if ($this->is_default !== $v) {
			$this->is_default = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::IS_DEFAULT;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v || $v === true) {
			$this->is_active = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::IS_ACTIVE;
		}
	...
	public function setIsSystem($v)
	{
		...
		if ($this->is_system !== $v || $v === false) {
			$this->is_system = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\RolePeer::IS_SYSTEM;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = \net\keeko\cms\core\entities\peer\RolePeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\RolePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\RolePeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\RolePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\RolePeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\RolePeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\RolePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\RolePeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\RolePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = \net\keeko\cms\core\entities\peer\RolePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\RolePeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\RolePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::USER_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::NAME)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::NAME, $this->name);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::IS_GUEST)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::IS_GUEST, $this->is_guest);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::IS_DEFAULT)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::IS_DEFAULT, $this->is_default);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::IS_ACTIVE)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\RolePeer::IS_SYSTEM)) $criteria->add(\net\keeko\cms\core\entities\peer\RolePeer::IS_SYSTEM, $this->is_system);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Role (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Role Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\Role has previously been saved, it will retrieve
	 * related RoleActions from storage. If this net\keeko\cms\core\entities\Role is new, it will return
		...
		if ($this->collRoleActions === null) {
			if ($this->isNew()) {
			   $this->collRoleActions = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\RoleActionPeer::ROLE_ID, $this->id);
	...
	public function getRoleActionsJoinAction($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		if ($this->collRoleActions === null) {
			if ($this->isNew()) {
				...
				$this->collRoleActions = \net\keeko\cms\core\entities\peer\RoleActionPeer::doSelectJoinAction($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Role has previously been saved, it will retrieve
	 * related RoleUsers from storage. If this net\keeko\cms\core\entities\Role is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collRoleUsers === null) {
			if ($this->isNew()) {
			   $this->collRoleUsers = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\RoleUserPeer::ROLE_ID, $this->id);
	...
	public function getRoleUsersJoinUser($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		if ($this->collRoleUsers === null) {
			if ($this->isNew()) {
				...
				$this->collRoleUsers = \net\keeko\cms\core\entities\peer\RoleUserPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this net\keeko\cms\core\entities\Role has previously been saved, it will retrieve
	 * related PagePermissions from storage. If this net\keeko\cms\core\entities\Role is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPagePermissions === null) {
			if ($this->isNew()) {
			   $this->collPagePermissions = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\PagePermissionPeer::ROLE_ID, $this->id);
	 ...
	 * actually need in Role.
	 */
	public function getPagePermissionsJoinPage($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\RolePeer::DATABASE_NAME);
		}
		...
		if ($this->collPagePermissions === null) {
			if ($this->isNew()) {
				...
				$this->collPagePermissions = \net\keeko\cms\core\entities\peer\PagePermissionPeer::doSelectJoinPage($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseRole
