...
abstract class BaseUnit extends \BaseObject  implements \Persistent {
	 ...
	 * @var        \net\keeko\cms\core\entities\peer\UnitPeer
	 */
	...
	/**
	 * Initializes internal state of net\keeko\cms\core\entities\base\BaseUnit object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UnitPeer::ID;
		}
	...
	public function setGridId($v)
	{
		...
		if ($this->grid_id !== $v) {
			$this->grid_id = $v;
			$this->modifiedColumns[] = \net\keeko\cms\core\entities\peer\UnitPeer::GRID_ID;
		}

		if ($this->aGrid !== null && $this->aGrid->getId() !== $v) {
			$this->aGrid = null;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = \net\keeko\cms\core\entities\peer\UnitPeer::NUM_COLUMNS - \net\keeko\cms\core\entities\peer\UnitPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aGrid !== null && $this->grid_id !== $this->aGrid->getId()) {
			$this->aGrid = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, \PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UnitPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}

		// We don't need to alter the object instance pool; we're just modifying this instance
		// already in the pool.

		$stmt = \net\keeko\cms\core\entities\peer\UnitPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(\PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = \Propel::getConnection(\net\keeko\cms\core\entities\peer\UnitPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		
		$con->beginTransaction();
		try {
			\net\keeko\cms\core\entities\peer\UnitPeer::doDelete($this, $con);
	...
	public function save(\PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			\net\keeko\cms\core\entities\peer\UnitPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (\PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(\PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aGrid !== null) {
				if ($this->aGrid->isModified() || $this->aGrid->isNew()) {
					$affectedRows += $this->aGrid->save($con);
				}
				$this->setGrid($this->aGrid);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = \net\keeko\cms\core\entities\peer\UnitPeer::doInsert($this, $con);
					...
					$affectedRows += \net\keeko\cms\core\entities\peer\UnitPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aGrid !== null) {
				if (!$this->aGrid->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aGrid->getValidationFailures());
				}
			}


			if (($retval = \net\keeko\cms\core\entities\peer\UnitPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = \net\keeko\cms\core\entities\peer\UnitPeer::translateFieldName($name, $type, \BasePeer::TYPE_NUM);
	...
	{
		$keys = \net\keeko\cms\core\entities\peer\UnitPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	{
		$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UnitPeer::DATABASE_NAME);

		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UnitPeer::ID)) $criteria->add(\net\keeko\cms\core\entities\peer\UnitPeer::ID, $this->id);
		if ($this->isColumnModified(\net\keeko\cms\core\entities\peer\UnitPeer::GRID_ID)) $criteria->add(\net\keeko\cms\core\entities\peer\UnitPeer::GRID_ID, $this->grid_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of net\keeko\cms\core\entities\Unit (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     net\keeko\cms\core\entities\Unit Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * @throws     PropelException
	 */
	public function getGrid(\PropelPDO $con = null)
	{
		if ($this->aGrid === null && ($this->grid_id !== null)) {
	 ...
	 * Otherwise if this net\keeko\cms\core\entities\Unit has previously been saved, it will retrieve
	 * related UnitActions from storage. If this net\keeko\cms\core\entities\Unit is new, it will return
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
			   $this->collUnitActions = array();
				...
				$criteria->add(\net\keeko\cms\core\entities\peer\UnitActionPeer::UNIT_ID, $this->id);
	 ...
	 */
	public function getUnitActionsJoinAction($criteria = null, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new \Criteria(\net\keeko\cms\core\entities\peer\UnitPeer::DATABASE_NAME);
		}
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
				...
				$this->collUnitActions = \net\keeko\cms\core\entities\peer\UnitActionPeer::doSelectJoinAction($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
...
} // net\keeko\cms\core\entities\base\BaseUnit
