...
class BlockActionMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\BlockActionMapBuilder';
	...
	{
		$this->dbMap = \Propel::getDatabaseMap(net\keeko\cms\core\entities\peer\BlockActionPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(net\keeko\cms\core\entities\peer\BlockActionPeer::TABLE_NAME);
		$tMap->setPhpName('BlockAction');
		$tMap->setClassname('net\keeko\cms\core\entities\BlockAction');
...
} // net\keeko\cms\core\entities\map\BlockActionMapBuilder
