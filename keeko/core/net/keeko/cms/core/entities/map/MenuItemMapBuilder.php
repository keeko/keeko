...
class MenuItemMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.MenuItemMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(MenuItemPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(MenuItemPeer::TABLE_NAME);
		$tMap->setPhpName('MenuItem');
		$tMap->setClassname('MenuItem');
