...
class UnitMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\UnitMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\UnitPeer::TABLE_NAME);
		$tMap->setPhpName('Unit');
		$tMap->setClassname('net\keeko\cms\core\entities\Unit');
...
} // net\keeko\cms\core\entities\map\UnitMapBuilder
