...
class PageJsMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\PageJsMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\PageJsPeer::TABLE_NAME);
		$tMap->setPhpName('PageJs');
		$tMap->setClassname('net\keeko\cms\core\entities\PageJs');
...
} // net\keeko\cms\core\entities\map\PageJsMapBuilder
