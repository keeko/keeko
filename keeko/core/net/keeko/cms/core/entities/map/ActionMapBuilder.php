...
/**
 * This class adds structure of 'action' table to 'keeko' DatabaseMap object.
 *
 *
 *
...
class ActionMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\ActionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\ActionPeer::TABLE_NAME);
		$tMap->setPhpName('Action');
		$tMap->setClassname('net\keeko\cms\core\entities\Action');
...
} // net\keeko\cms\core\entities\map\ActionMapBuilder
