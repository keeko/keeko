...
class MenuMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\MenuMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\MenuPeer::TABLE_NAME);
		$tMap->setPhpName('Menu');
		$tMap->setClassname('net\keeko\cms\core\entities\Menu');
...
} // net\keeko\cms\core\entities\map\MenuMapBuilder
