...
class RoleUserMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.RoleUserMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(RoleUserPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(RoleUserPeer::TABLE_NAME);
		$tMap->setPhpName('RoleUser');
		$tMap->setClassname('RoleUser');
