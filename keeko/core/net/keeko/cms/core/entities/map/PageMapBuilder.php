...
class PageMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\PageMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\PagePeer::TABLE_NAME);
		$tMap->setPhpName('Page');
		$tMap->setClassname('net\keeko\cms\core\entities\Page');
...
} // net\keeko\cms\core\entities\map\PageMapBuilder
