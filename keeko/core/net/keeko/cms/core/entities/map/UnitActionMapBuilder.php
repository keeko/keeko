...
class UnitActionMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\UnitActionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\UnitActionPeer::TABLE_NAME);
		$tMap->setPhpName('UnitAction');
		$tMap->setClassname('net\keeko\cms\core\entities\UnitAction');
...
} // net\keeko\cms\core\entities\map\UnitActionMapBuilder
