...
class UserExtMapBuilder implements ::MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.UserExtMapBuilder';
	...
	{
		$this->dbMap = ::Propel::getDatabaseMap(UserExtPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(UserExtPeer::TABLE_NAME);
		$tMap->setPhpName('UserExt');
		$tMap->setClassname('UserExt');
