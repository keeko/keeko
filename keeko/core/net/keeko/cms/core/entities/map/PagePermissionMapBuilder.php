...
class PagePermissionMapBuilder implements \MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'net.keeko.cms.core.entities.map.net\keeko\cms\core\entities\map\PagePermissionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable(\net\keeko\cms\core\entities\peer\PagePermissionPeer::TABLE_NAME);
		$tMap->setPhpName('PagePermission');
		$tMap->setClassname('net\keeko\cms\core\entities\PagePermission');
...
} // net\keeko\cms\core\entities\map\PagePermissionMapBuilder
