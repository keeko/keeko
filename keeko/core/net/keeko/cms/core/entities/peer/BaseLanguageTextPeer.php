...
abstract class BaseLanguageTextPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\LanguageTextMapBuilder();
		}
	...
	public static function doCount(\Criteria $criteria, $distinct = false, \PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(LanguageTextPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = \Propel::getConnection(LanguageTextPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\LanguageText $value A \net\keeko\cms\core\entities\LanguageText object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\LanguageText $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\LanguageText object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\LanguageText) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\LanguageText object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\LanguageText Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinLanguage(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(LanguageTextPeer::LANGUAGE_ID,), array(LanguagePeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\LanguageText objects pre-filled with their \net\keeko\cms\core\entities\Language objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinLanguage(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(LanguageTextPeer::LANGUAGE_ID,), array(LanguagePeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\LanguageText objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\LanguageText) to the collection in $obj2 (\net\keeko\cms\core\entities\Language)
				$obj2->addLanguageText($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\LanguageText or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\LanguageText object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = \Propel::getConnection(LanguageTextPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(LanguageTextPeer::ID) && $criteria->keyContainsValue(LanguageTextPeer::ID) ) {
			throw new \PropelException('Cannot insert a value for auto-increment primary key ('.LanguageTextPeer::ID.')');
		}
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\LanguageText object containing data that is used to create the UPDATE statement.
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += LanguageTextPeer::doOnDeleteCascade(new \Criteria(LanguageTextPeer::DATABASE_NAME), $con);
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\LanguageText or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\LanguageText object or primary key or array of primary keys
	 ...
	 public static function doDelete($values, \PropelPDO $con = null)
	 {
		...
		if ($values instanceof \Criteria) {
			...
			foreach ((array) $values as $singleval) {
				...
				LanguageTextPeer::removeInstanceFromPool($singleval);
			}
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\LanguageText $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\LanguageText $obj, $cols = null)
	{
		$columns = array();
	...
	{
		if (null !== ($obj = LanguageTextPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
