...
abstract class BaseUnitPeer {
	...
	private static $fieldNames = array (
		\BasePeer::TYPE_PHPNAME => array ('Id', 'GridId', ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'gridId', ),
		\BasePeer::TYPE_COLNAME => array (self::ID, self::GRID_ID, ),
		\BasePeer::TYPE_FIELDNAME => array ('id', 'grid_id', ),
	...
	private static $fieldKeys = array (
		\BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'GridId' => 1, ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'gridId' => 1, ),
		\BasePeer::TYPE_COLNAME => array (self::ID => 0, self::GRID_ID => 1, ),
		\BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'grid_id' => 1, ),
		\BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\UnitMapBuilder();
		}
	...
	public static function addSelectColumns(\Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UnitPeer::GRID_ID);
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Unit $value A \net\keeko\cms\core\entities\Unit object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Unit $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Unit object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Unit) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Unit object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Unit Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinGrid(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UnitPeer::GRID_ID,), array(GridPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinGrid(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(UnitPeer::GRID_ID,), array(GridPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Unit objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			// Add objects for joined \net\keeko\cms\core\entities\Grid rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Unit) to the collection in $obj2 (\net\keeko\cms\core\entities\Grid)
				$obj2->addUnit($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Unit or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Unit object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Unit object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Unit or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Unit object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Unit $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Unit $obj, $cols = null)
	{
		$columns = array();
...
//
// NOTE: This static code cannot call methods on the UnitPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the UnitPeer class:
//
// Propel::getDatabaseMap(UnitPeer::DATABASE_NAME)->addTableBuilder(UnitPeer::TABLE_NAME, UnitPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

\Propel::getDatabaseMap(BaseUnitPeer::DATABASE_NAME)->addTableBuilder(BaseUnitPeer::TABLE_NAME, BaseUnitPeer::getMapBuilder());
