...
abstract class BaseSettingPeer {
	...
	private static $fieldNames = array (
		\BasePeer::TYPE_PHPNAME => array ('Keyname', 'SectionId', 'ModuleId', 'Value', 'Format', 'Hide', ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('keyname', 'sectionId', 'moduleId', 'value', 'format', 'hide', ),
		\BasePeer::TYPE_COLNAME => array (self::KEYNAME, self::SECTION_ID, self::MODULE_ID, self::VALUE, self::FORMAT, self::HIDE, ),
		\BasePeer::TYPE_FIELDNAME => array ('keyname', 'section_id', 'module_id', 'value', 'format', 'hide', ),
	...
	private static $fieldKeys = array (
		\BasePeer::TYPE_PHPNAME => array ('Keyname' => 0, 'SectionId' => 1, 'ModuleId' => 2, 'Value' => 3, 'Format' => 4, 'Hide' => 5, ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('keyname' => 0, 'sectionId' => 1, 'moduleId' => 2, 'value' => 3, 'format' => 4, 'hide' => 5, ),
		\BasePeer::TYPE_COLNAME => array (self::KEYNAME => 0, self::SECTION_ID => 1, self::MODULE_ID => 2, self::VALUE => 3, self::FORMAT => 4, self::HIDE => 5, ),
		\BasePeer::TYPE_FIELDNAME => array ('keyname' => 0, 'section_id' => 1, 'module_id' => 2, 'value' => 3, 'format' => 4, 'hide' => 5, ),
		\BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\SettingMapBuilder();
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Setting $value A \net\keeko\cms\core\entities\Setting object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Setting $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Setting object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Setting) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Setting object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Setting Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinModule(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(SettingPeer::MODULE_ID,), array(ModulePeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinSettingSection(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(array(SettingPeer::SECTION_ID,), array(SettingSectionPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Setting objects pre-filled with their \net\keeko\cms\core\entities\Module objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinModule(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(SettingPeer::MODULE_ID,), array(ModulePeer::ID,), $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSettingSection(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(SettingPeer::SECTION_ID,), array(SettingSectionPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doSelect($c, $con);
		$results = array();
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Setting objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Setting) to the collection in $obj2 (\net\keeko\cms\core\entities\Module)
				$obj2->addSetting($obj1);
			} // if joined row not null

			// Add objects for joined \net\keeko\cms\core\entities\SettingSection rows
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Setting) to the collection in $obj3 (\net\keeko\cms\core\entities\SettingSection)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptSettingSection(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Setting objects pre-filled with all related objects except Module.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptModule(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		SettingSectionPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + (SettingSectionPeer::NUM_COLUMNS - SettingSectionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = SettingPeer::getInstanceFromPool($key1))) {
				...
				$key2 = SettingSectionPeer::getPrimaryKeyHashFromRow($row, $startcol2);
				if ($key2 !== null) {
					$obj2 = SettingSectionPeer::getInstanceFromPool($key2);
					if (!$obj2) {
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Setting objects pre-filled with all related objects except SettingSection.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptSettingSection(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Setting or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Setting object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Setting object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Setting or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Setting object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Setting $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Setting $obj, $cols = null)
	{
		$columns = array();
