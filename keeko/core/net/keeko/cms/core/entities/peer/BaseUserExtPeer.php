...
abstract class BaseUserExtPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\UserExtMapBuilder();
		}
	...
	public static function doCount(\Criteria $criteria, $distinct = false, \PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(UserExtPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = \Propel::getConnection(UserExtPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UserExt $value A \net\keeko\cms\core\entities\UserExt object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\UserExt $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\UserExt object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\UserExt) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\UserExt object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\UserExt Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinLanguageText(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserExtPeer::NAME_ID,), array(LanguageTextPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUserExtCat(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(array(UserExtPeer::CAT_ID,), array(UserExtCatPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	public static function doSelectJoinLanguageText(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(UserExtPeer::NAME_ID,), array(LanguageTextPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserExt objects pre-filled with their \net\keeko\cms\core\entities\UserExtCat objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 * @return     array Array of \net\keeko\cms\core\entities\UserExt objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUserExtCat(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(UserExtPeer::CAT_ID,), array(UserExtCatPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UserExt) to $obj2 (\net\keeko\cms\core\entities\\net\keeko\cms\core\entities\UserExtCat)
				$obj2->addUserExt($obj1);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserExt objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UserExt) to the collection in $obj2 (\net\keeko\cms\core\entities\LanguageText)
				$obj2->addUserExt($obj1);
			} // if joined row not null

			// Add objects for joined \net\keeko\cms\core\entities\UserExtCat rows
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UserExt) to the collection in $obj3 (\net\keeko\cms\core\entities\UserExtCat)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUserExtCat(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserExt objects pre-filled with all related objects except LanguageText.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserExt objects pre-filled with all related objects except UserExtCat.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUserExtCat(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\UserExt or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserExt object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = \Propel::getConnection(UserExtPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserExt object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\UserExt or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserExt object or primary key or array of primary keys
	 ...
	 public static function doDelete($values, \PropelPDO $con = null)
	 {
		...
		if ($values instanceof \Criteria) {
			...
			foreach ((array) $values as $singleval) {
				...
				UserExtPeer::removeInstanceFromPool($singleval);
			}
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UserExt $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\UserExt $obj, $cols = null)
	{
		$columns = array();
	...
	{
		if (null !== ($obj = UserExtPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
