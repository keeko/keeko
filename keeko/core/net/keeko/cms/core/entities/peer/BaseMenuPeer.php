...
abstract class BaseMenuPeer {
	...
	private static $fieldNames = array (
		\BasePeer::TYPE_PHPNAME => array ('Id', 'AppId', 'Name', ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'appId', 'name', ),
		\BasePeer::TYPE_COLNAME => array (self::ID, self::APP_ID, self::NAME, ),
		\BasePeer::TYPE_FIELDNAME => array ('id', 'app_id', 'name', ),
	...
	private static $fieldKeys = array (
		\BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AppId' => 1, 'Name' => 2, ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'appId' => 1, 'name' => 2, ),
		\BasePeer::TYPE_COLNAME => array (self::ID => 0, self::APP_ID => 1, self::NAME => 2, ),
		\BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'app_id' => 1, 'name' => 2, ),
		\BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\MenuMapBuilder();
		}
	...
	public static function addSelectColumns(\Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MenuPeer::APP_ID);
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Menu $value A \net\keeko\cms\core\entities\Menu object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Menu $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Menu object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Menu) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Menu object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Menu Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinApp(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(MenuPeer::APP_ID,), array(AppPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Menu objects pre-filled with their \net\keeko\cms\core\entities\App objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinApp(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(MenuPeer::APP_ID,), array(AppPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Menu objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Menu) to the collection in $obj2 (\net\keeko\cms\core\entities\App)
				$obj2->addMenu($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Menu or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Menu object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Menu object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Menu or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Menu object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Menu $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Menu $obj, $cols = null)
	{
		$columns = array();
