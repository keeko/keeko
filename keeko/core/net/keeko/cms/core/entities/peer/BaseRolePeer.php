...
abstract class BaseRolePeer {
	...
	const IS_GUEST = 'role.IS_GUEST';

	/** the column name for the IS_DEFAULT field */
	const IS_DEFAULT = 'role.IS_DEFAULT';
	...
	private static $fieldNames = array (
		...
		\BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::NAME, self::IS_GUEST, self::IS_DEFAULT, self::IS_ACTIVE, self::IS_SYSTEM, ),
	...
	private static $fieldKeys = array (
		...
		\BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::NAME => 2, self::IS_GUEST => 3, self::IS_DEFAULT => 4, self::IS_ACTIVE => 5, self::IS_SYSTEM => 6, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\RoleMapBuilder();
		}
	...
	public static function addSelectColumns(\Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RolePeer::USER_ID);

		$criteria->addSelectColumn(RolePeer::NAME);

		$criteria->addSelectColumn(RolePeer::IS_GUEST);

		$criteria->addSelectColumn(RolePeer::IS_DEFAULT);

		$criteria->addSelectColumn(RolePeer::IS_ACTIVE);

		$criteria->addSelectColumn(RolePeer::IS_SYSTEM);
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Role $value A \net\keeko\cms\core\entities\Role object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Role $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Role object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Role) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Role object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Role Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinUser(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(RolePeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	public static function doSelectJoinUser(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(RolePeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Role objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Role) to the collection in $obj2 (\net\keeko\cms\core\entities\User)
				$obj2->addRole($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Role or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Role object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Role object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Role or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Role object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Role $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Role $obj, $cols = null)
	{
		$columns = array();
