...
abstract class BaseModulePeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\ModuleMapBuilder();
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Module $value A \net\keeko\cms\core\entities\Module object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Module $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Module object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Module) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Module object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Module Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Module or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Module object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Module object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Module or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Module object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Module $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Module $obj, $cols = null)
	{
		$columns = array();
