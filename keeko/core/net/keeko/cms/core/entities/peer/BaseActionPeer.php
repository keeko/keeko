...
abstract class BaseActionPeer {
	...
	const MODULE_ID = 'action.MODULE_ID';
	...
	private static $fieldNames = array (
		...
		\BasePeer::TYPE_COLNAME => array (self::ID, self::MODULE_ID, self::NAME, ),
	...
	private static $fieldKeys = array (
		...
		\BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MODULE_ID => 1, self::NAME => 2, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\ActionMapBuilder();
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Action $value A \net\keeko\cms\core\entities\Action object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Action $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Action object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Action) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Action object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Action Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinModule(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ActionPeer::MODULE_ID,), array(ModulePeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	public static function doSelectJoinModule(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(ActionPeer::MODULE_ID,), array(ModulePeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\Action objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		ActionPeer::addSelectColumns($c);
		$startcol2 = (ActionPeer::NUM_COLUMNS - ActionPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\Action) to the collection in $obj2 (\net\keeko\cms\core\entities\Module)
				$obj2->addAction($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Action or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Action object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Action object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Action or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Action object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Action $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Action $obj, $cols = null)
	{
		$columns = array();
