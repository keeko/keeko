...
abstract class BaseUserSettingValuePeer {
	...
	/**
	 * An identiy map to hold any loaded instances of \net\keeko\cms\core\entities\UserSettingValue objects.
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\UserSettingValueMapBuilder();
		}
	...
	public static function doCount(\Criteria $criteria, $distinct = false, \PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(UserSettingValuePeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = \Propel::getConnection(UserSettingValuePeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UserSettingValue $value A \net\keeko\cms\core\entities\UserSettingValue object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\UserSettingValue $obj, $key = null)
	{
		if (\Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getUserId(), (string) $obj->getKeyname()));
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\UserSettingValue object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\UserSettingValue) {
				$key = serialize(array((string) $value->getUserId(), (string) $value->getKeyname()));
			} elseif (is_array($value) && count($value) === 2) {
				// assume we've been passed a primary key
				$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\UserSettingValue object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\UserSettingValue Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinUserSetting(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserSettingValuePeer::KEYNAME,), array(UserSettingPeer::KEYNAME,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	public static function doCountJoinUser(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserSettingValuePeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserSettingValue objects pre-filled with their \net\keeko\cms\core\entities\UserSetting objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUserSetting(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(UserSettingValuePeer::KEYNAME,), array(UserSettingPeer::KEYNAME,), $join_behavior);
	...
	public static function doSelectJoinUser(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(UserSettingValuePeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doSelect($c, $con);
		$results = array();
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserSettingValue objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			// Add objects for joined \net\keeko\cms\core\entities\UserSetting rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UserSettingValue) to the collection in $obj2 (\net\keeko\cms\core\entities\UserSetting)
				$obj2->addUserSettingValue($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UserSettingValue) to the collection in $obj3 (\net\keeko\cms\core\entities\User)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptUserSetting(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserSettingValue objects pre-filled with all related objects except UserSetting.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUserSetting(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UserSettingValue objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\UserSettingValue or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserSettingValue object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = \Propel::getConnection(UserSettingValuePeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserSettingValue object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\UserSettingValue or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UserSettingValue object or primary key or array of primary keys
	 ...
	 public static function doDelete($values, \PropelPDO $con = null)
	 {
		...
		if ($values instanceof \Criteria) {
			...
			foreach ($values as $value) {
				...
				UserSettingValuePeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UserSettingValue $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\UserSettingValue $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($user_id, $keyname, \PropelPDO $con = null) {
		$key = serialize(array((string) $user_id, (string) $keyname));
 		if (null !== ($obj = UserSettingValuePeer::getInstanceFromPool($key))) {
 			return $obj;
		}
		...
		$criteria = new \Criteria(UserSettingValuePeer::DATABASE_NAME);
