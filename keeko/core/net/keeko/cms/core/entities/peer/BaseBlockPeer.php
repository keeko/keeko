...
abstract class BaseBlockPeer {
	...
	/** the column name for the IS_CONTENT field */
	const IS_CONTENT = 'block.IS_CONTENT';
	...
	private static $fieldNames = array (
		\BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'IsContent', ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'isContent', ),
		\BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::IS_CONTENT, ),
		\BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'is_content', ),
	...
	private static $fieldKeys = array (
		\BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'IsContent' => 2, ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'isContent' => 2, ),
		\BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::IS_CONTENT => 2, ),
		\BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'is_content' => 2, ),
		\BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\BlockMapBuilder();
		}
	...
	public static function addSelectColumns(\Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BlockPeer::IS_CONTENT);
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Block $value A \net\keeko\cms\core\entities\Block object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\Block $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\Block object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\Block) {
				...
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\Block object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\Block Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\Block or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Block object containing data that is used to create the INSERT statement.
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Block object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\Block or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\Block object or primary key or array of primary keys
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\Block $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\Block $obj, $cols = null)
	{
		$columns = array();
...
//
// NOTE: This static code cannot call methods on the BlockPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the BlockPeer class:
//
// Propel::getDatabaseMap(BlockPeer::DATABASE_NAME)->addTableBuilder(BlockPeer::TABLE_NAME, BlockPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

\Propel::getDatabaseMap(BaseBlockPeer::DATABASE_NAME)->addTableBuilder(BaseBlockPeer::TABLE_NAME, BaseBlockPeer::getMapBuilder());
