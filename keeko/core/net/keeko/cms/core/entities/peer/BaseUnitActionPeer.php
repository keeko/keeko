...
abstract class BaseUnitActionPeer {
	...
	private static $fieldNames = array (
		\BasePeer::TYPE_PHPNAME => array ('UnitId', 'ActionId', ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('unitId', 'actionId', ),
		\BasePeer::TYPE_COLNAME => array (self::UNIT_ID, self::ACTION_ID, ),
		\BasePeer::TYPE_FIELDNAME => array ('unit_id', 'action_id', ),
	...
	private static $fieldKeys = array (
		\BasePeer::TYPE_PHPNAME => array ('UnitId' => 0, 'ActionId' => 1, ),
		\BasePeer::TYPE_STUDLYPHPNAME => array ('unitId' => 0, 'actionId' => 1, ),
		\BasePeer::TYPE_COLNAME => array (self::UNIT_ID => 0, self::ACTION_ID => 1, ),
		\BasePeer::TYPE_FIELDNAME => array ('unit_id' => 0, 'action_id' => 1, ),
		\BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new \net\keeko\cms\core\entities\map\UnitActionMapBuilder();
		}
	...
	public static function doCount(\Criteria $criteria, $distinct = false, \PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(UnitActionPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = \Propel::getConnection(UnitActionPeer::DATABASE_NAME, \Propel::CONNECTION_READ);
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UnitAction $value A \net\keeko\cms\core\entities\UnitAction object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(\net\keeko\cms\core\entities\UnitAction $obj, $key = null)
	{
		if (\Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getUnitId(), (string) $obj->getActionId()));
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A \net\keeko\cms\core\entities\UnitAction object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (\Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof \net\keeko\cms\core\entities\UnitAction) {
				$key = serialize(array((string) $value->getUnitId(), (string) $value->getActionId()));
			} elseif (is_array($value) && count($value) === 2) {
				// assume we've been passed a primary key
				$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new \PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \net\keeko\cms\core\entities\UnitAction object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     \net\keeko\cms\core\entities\UnitAction Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinUnit(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UnitActionPeer::UNIT_ID,), array(UnitPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	public static function doCountJoinAction(\Criteria $criteria, $distinct = false, \PropelPDO $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UnitActionPeer::ACTION_ID,), array(ActionPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UnitAction objects pre-filled with their \net\keeko\cms\core\entities\Unit objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUnit(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(UnitActionPeer::UNIT_ID,), array(UnitPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UnitAction) to $obj2 (\net\keeko\cms\core\entities\\net\keeko\cms\core\entities\Unit)
	...
	public static function doSelectJoinAction(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(UnitActionPeer::ACTION_ID,), array(ActionPeer::ID,), $join_behavior);
		$stmt = \BasePeer::doSelect($c, $con);
		$results = array();
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UnitAction objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
			...
			// Add objects for joined \net\keeko\cms\core\entities\Unit rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UnitAction) to the collection in $obj2 (\net\keeko\cms\core\entities\Unit)
				$obj2->addUnitAction($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (\net\keeko\cms\core\entities\UnitAction) to the collection in $obj3 (\net\keeko\cms\core\entities\Action)
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UnitAction objects pre-filled with all related objects except Unit.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptUnit(\Criteria $c, $con = null, $join_behavior = \Criteria::LEFT_JOIN)
	{
		$c = clone $c;
	...
	/**
	 * Selects a collection of \net\keeko\cms\core\entities\UnitAction objects pre-filled with all related objects except Action.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to \Criteria::LEFT_JOIN
	...
	/**
	 * Method perform an INSERT on the database, given a \net\keeko\cms\core\entities\UnitAction or Criteria object.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UnitAction object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = \Propel::getConnection(UnitActionPeer::DATABASE_NAME, \Propel::CONNECTION_WRITE);
		}
	 ...
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UnitAction object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a \net\keeko\cms\core\entities\UnitAction or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or \net\keeko\cms\core\entities\UnitAction object or primary key or array of primary keys
	 ...
	 public static function doDelete($values, \PropelPDO $con = null)
	 {
		...
		if ($values instanceof \Criteria) {
			...
			foreach ($values as $value) {
				...
				UnitActionPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 *
	 * @param      \net\keeko\cms\core\entities\UnitAction $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(\net\keeko\cms\core\entities\UnitAction $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($unit_id, $action_id, \PropelPDO $con = null) {
		$key = serialize(array((string) $unit_id, (string) $action_id));
 		if (null !== ($obj = UnitActionPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
