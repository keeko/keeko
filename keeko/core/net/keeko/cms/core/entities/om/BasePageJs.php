...
abstract class BasePageJs extends ::BaseObject  implements ::Persistent {
	...
	/**
	 * Initializes internal state of BasePageJs object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PageJs The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PageJsPeer::ID;
		}
	...
	public function setPageId($v)
	{
		...
		if ($this->page_id !== $v) {
			$this->page_id = $v;
			$this->modifiedColumns[] = PageJsPeer::PAGE_ID;
		}
	...
	public function setPath($v)
	{
		...
		if ($this->path !== $v) {
			$this->path = $v;
			$this->modifiedColumns[] = PageJsPeer::PATH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PageJsPeer::NUM_COLUMNS - PageJsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		$stmt = PageJsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(::PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			PageJsPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (::PropelException $e) {
			$con->rollback();
			throw $e;
	...
	protected function doSave(::PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PageJsPeer::doInsert($this, $con);
					...
					$affectedRows += PageJsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PageJsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PageJsPeer::translateFieldName($name, $type, ::BasePeer::TYPE_NUM);
	...
	{
		$keys = PageJsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PageJsPeer::ID)) $criteria->add(PageJsPeer::ID, $this->id);
		if ($this->isColumnModified(PageJsPeer::PAGE_ID)) $criteria->add(PageJsPeer::PAGE_ID, $this->page_id);
		if ($this->isColumnModified(PageJsPeer::PATH)) $criteria->add(PageJsPeer::PATH, $this->path);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PageJsPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PageJs (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PageJs Clone of current object.
	 * @throws     ::PropelException
	 */
