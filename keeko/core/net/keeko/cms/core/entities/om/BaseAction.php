...
abstract class BaseAction extends ::BaseObject  implements ::Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ActionPeer::NUM_COLUMNS - ActionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = ::Propel::getConnection(ActionPeer::DATABASE_NAME);
		}
	 ...
	 * related MenuItems from storage. If this Action is new, it will return
		...
		if ($this->collMenuItems === null) {
			if ($this->isNew()) {
			   $this->collMenuItems = array();
				...
				$criteria->add(MenuItemPeer::ACTION_ID, $this->getId());
	 ...
	 * If this collection has already been initialized with an identical ::Criteria, it returns the collection.
	 * Otherwise if this Action has previously been saved, it will retrieve
	 * related RoleActions from storage. If this Action is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      ::PropelPDO $con
	 * @param      ::Criteria $criteria
		...
		if ($this->collRoleActions === null) {
			if ($this->isNew()) {
			   $this->collRoleActions = array();
				...
				$criteria->add(RoleActionPeer::ACTION_ID, $this->getId());
	 ...
	 * actually need in Action.
	 */
	public function getRoleActionsJoinRole($criteria = null, $con = null)
	{
		...
		if ($this->collRoleActions === null) {
			if ($this->isNew()) {
				...
				$this->collRoleActions = RoleActionPeer::doSelectJoinRole($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical ::Criteria, it returns the collection.
	 * Otherwise if this Action has previously been saved, it will retrieve
	 * related UnitActions from storage. If this Action is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      ::PropelPDO $con
	 * @param      ::Criteria $criteria
		...
		if ($this->collUnitActions === null) {
			if ($this->isNew()) {
			   $this->collUnitActions = array();
				...
				$criteria->add(UnitActionPeer::ACTION_ID, $this->getId());
	 ...
	 * If this collection has already been initialized with an identical ::Criteria, it returns the collection.
	 * Otherwise if this Action has previously been saved, it will retrieve
	 * related BlockActions from storage. If this Action is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      ::PropelPDO $con
	 * @param      ::Criteria $criteria
		...
		if ($this->collBlockActions === null) {
			if ($this->isNew()) {
			   $this->collBlockActions = array();
				...
				$criteria->add(BlockActionPeer::ACTION_ID, $this->getId());
