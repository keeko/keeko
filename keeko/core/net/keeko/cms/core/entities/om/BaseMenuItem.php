...
abstract class BaseMenuItem extends ::BaseObject  implements ::Persistent {
	...
	public function setTextId($v)
	{
		...
		if ($this->text_id !== $v) {
			$this->text_id = $v;
			$this->modifiedColumns[] = MenuItemPeer::TEXT_ID;
		}
	...
	public function setPageId($v)
	{
		...
		if ($this->page_id !== $v || $v === 0) {
			$this->page_id = $v;
			$this->modifiedColumns[] = MenuItemPeer::PAGE_ID;
		}
	...
	public function setModuleId($v)
	{
		...
		if ($this->module_id !== $v || $v === 0) {
			$this->module_id = $v;
			$this->modifiedColumns[] = MenuItemPeer::MODULE_ID;
		}
	...
	public function setActionId($v)
	{
		...
		if ($this->action_id !== $v || $v === 0) {
			$this->action_id = $v;
			$this->modifiedColumns[] = MenuItemPeer::ACTION_ID;
		}
	...
	public function setEvent($v)
	{
		...
		if ($this->event !== $v) {
			$this->event = $v;
			$this->modifiedColumns[] = MenuItemPeer::EVENT;
		}
	...
	public function setImage($v)
	{
		...
		if ($this->image !== $v) {
			$this->image = $v;
			$this->modifiedColumns[] = MenuItemPeer::IMAGE;
		}
	...
	public function setSortorder($v)
	{
		...
		if ($this->sortorder !== $v) {
			$this->sortorder = $v;
			$this->modifiedColumns[] = MenuItemPeer::SORTORDER;
		}
	...
	public function setExtra($v)
	{
		...
		if ($this->extra !== $v) {
			$this->extra = $v;
			$this->modifiedColumns[] = MenuItemPeer::EXTRA;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(MenuItemPeer::PARENT_ID,MenuItemPeer::PAGE_ID,MenuItemPeer::MODULE_ID,MenuItemPeer::ACTION_ID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = MenuItemPeer::NUM_COLUMNS - MenuItemPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuItemPeer::TEXT_ID)) $criteria->add(MenuItemPeer::TEXT_ID, $this->text_id);
		if ($this->isColumnModified(MenuItemPeer::PAGE_ID)) $criteria->add(MenuItemPeer::PAGE_ID, $this->page_id);
		if ($this->isColumnModified(MenuItemPeer::MODULE_ID)) $criteria->add(MenuItemPeer::MODULE_ID, $this->module_id);
		if ($this->isColumnModified(MenuItemPeer::ACTION_ID)) $criteria->add(MenuItemPeer::ACTION_ID, $this->action_id);
		if ($this->isColumnModified(MenuItemPeer::EVENT)) $criteria->add(MenuItemPeer::EVENT, $this->event);
		if ($this->isColumnModified(MenuItemPeer::IMAGE)) $criteria->add(MenuItemPeer::IMAGE, $this->image);
		if ($this->isColumnModified(MenuItemPeer::SORTORDER)) $criteria->add(MenuItemPeer::SORTORDER, $this->sortorder);
		if ($this->isColumnModified(MenuItemPeer::EXTRA)) $criteria->add(MenuItemPeer::EXTRA, $this->extra);
	...
	public function getLanguageText(::PropelPDO $con = null)
	{
		if ($this->aLanguageText === null && ($this->text_id !== null)) {
			$this->aLanguageText = LanguageTextPeer::retrieveByPK($this->text_id, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	 ...
	 * @throws     ::PropelException
	 */
	public function setMenuItemRelatedByParentId(MenuItem $v = null)
	{
		if ($v === null) {
			$this->setParentId(0);
		} else {
	 ...
	 *				are automatically initialized in the addMenuItemsRelatedByParentId() method.
	 ...
	 * Otherwise if this MenuItem has previously been saved, it will retrieve
	 * related MenuItemsRelatedByParentId from storage. If this MenuItem is new, it will return
		...
		if ($this->collMenuItemsRelatedByParentId === null) {
			if ($this->isNew()) {
			   $this->collMenuItemsRelatedByParentId = array();
				...
				$criteria->add(MenuItemPeer::PARENT_ID, $this->getId());
	 ...
	 */
	public function getMenuItemsRelatedByParentIdJoinPage($criteria = null, $con = null)
	{
		...
		if ($this->collMenuItemsRelatedByParentId === null) {
			if ($this->isNew()) {
				...
				$this->collMenuItemsRelatedByParentId = MenuItemPeer::doSelectJoinPage($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in MenuItem.
	 */
	public function getMenuItemsRelatedByParentIdJoinLanguageText($criteria = null, $con = null)
	{
		...
		if ($this->collMenuItemsRelatedByParentId === null) {
			if ($this->isNew()) {
				...
				$this->collMenuItemsRelatedByParentId = MenuItemPeer::doSelectJoinLanguageText($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in MenuItem.
	 */
	public function getMenuItemsRelatedByParentIdJoinModule($criteria = null, $con = null)
	{
		...
		if ($this->collMenuItemsRelatedByParentId === null) {
			if ($this->isNew()) {
				...
				$this->collMenuItemsRelatedByParentId = MenuItemPeer::doSelectJoinModule($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in MenuItem.
	 */
	public function getMenuItemsRelatedByParentIdJoinAction($criteria = null, $con = null)
	{
		...
		if ($this->collMenuItemsRelatedByParentId === null) {
			if ($this->isNew()) {
				...
				$this->collMenuItemsRelatedByParentId = MenuItemPeer::doSelectJoinAction($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
