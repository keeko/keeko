...
use net::keeko::cms::core::entities::map::BlockMapBuilder;
...
abstract class BaseBlockPeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.Block';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new BlockMapBuilder();
		}
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$stmt = BlockPeer::doSelectStmt($criteria, $con);
	...
	public static function doInsert($values, ::PropelPDO $con = null)
	{
		...
		$criteria->remove(BlockPeer::ID); // remove pkey col since this table uses auto-increment
	 ...
	 */
	 public static function doDelete($values, ::PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Block) {
