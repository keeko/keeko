...
use net::keeko::cms::core::entities::map::RoleActionMapBuilder;
...
use net::keeko::cms::core::entities::RoleAction;
...
abstract class BaseRoleActionPeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.RoleAction';
	...
	/**
	 * An identiy map to hold any loaded instances of RoleAction objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array RoleAction[]
	 */
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new RoleActionMapBuilder();
		}
	...
	const COUNT = 'COUNT(role_action.ACTION_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT role_action.ACTION_ID)';
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		if ($distinct || in_array(::Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(RoleActionPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(RoleActionPeer::COUNT);
		}
		...
		$stmt = RoleActionPeer::doSelectStmt($criteria, $con);
	 ...
	 *
	 * @param      RoleAction $value A RoleAction object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(RoleAction $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A RoleAction object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (::Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof RoleAction) {
				$key = serialize($value->getPrimaryKey());
			} elseif (is_array($value)) {
				// assume we've been passed a primary key
				$key = serialize($value);
			} else {
				$e = new ::PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or RoleAction object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     RoleAction Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinRole(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(RoleActionPeer::ROLE_ID, RolePeer::ID, ::Criteria::LEFT_JOIN);
	...
	public static function doCountJoinAction(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(RoleActionPeer::ACTION_ID, ActionPeer::ID, ::Criteria::LEFT_JOIN);
	...
	/**
	 * Selects a collection of RoleAction objects pre-filled with their Role objects.
	 *
	 * @return     array Array of RoleAction objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	 */
	public static function doSelectJoinRole(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(RoleActionPeer::ROLE_ID, RolePeer::ID, ::Criteria::LEFT_JOIN);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RoleAction) to $obj2 (Role)
	...
	/**
	 * Selects a collection of RoleAction objects pre-filled with their Action objects.
	 *
	 * @return     array Array of RoleAction objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	public static function doSelectJoinAction(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(RoleActionPeer::ACTION_ID, ActionPeer::ID, ::Criteria::LEFT_JOIN);
		$stmt = ::BasePeer::doSelect($c, $con);
		$results = array();
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RoleAction) to $obj2 (Action)
				$obj2->addRoleAction($obj1);
	...
	/**
	 * Selects a collection of RoleAction objects pre-filled with all related objects.
	 *
	 * @return     array Array of RoleAction objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	public static function doSelectJoinAll(::Criteria $c, $con = null)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RoleAction) to the collection in $obj2 (Role)
				$obj2->addRoleAction($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (RoleAction) to the collection in $obj3 (Action)
	...
	/**
	 * Selects a collection of RoleAction objects pre-filled with all related objects except Role.
	 *
	 * @return     array Array of RoleAction objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	public static function doSelectJoinAllExceptRole(::Criteria $c, $con = null)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = RoleActionPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== (RoleActionPeer::getInstanceFromPool($key1))) {
				$obj1->hydrate($row, 0, true); // rehydrate
			} else {
				$omClass = RoleActionPeer::getOMClass();
				...
				// Add the $obj1 (RoleAction) to the collection in $obj2 (Action)
				$obj2->addRoleAction($obj1);
	...
	/**
	 * Selects a collection of RoleAction objects pre-filled with all related objects except Action.
	 *
	 * @return     array Array of RoleAction objects.
	 * @throws     ::PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a ::PropelException.
	...
	/**
	 * Method perform an INSERT on the database, given a RoleAction or ::Criteria object.
	 *
	 * @param      mixed $values ::Criteria or RoleAction object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, ::PropelPDO $con = null)
	{
		...
		if ($values instanceof ::Criteria) {
			...
			$criteria = $values->buildCriteria(); // build ::Criteria from RoleAction object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a RoleAction or ::Criteria object.
	 *
	 * @param      mixed $values ::Criteria or RoleAction object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, ::PropelPDO $con = null)
	{
		...
		} else { // $values is RoleAction object
	...
	/**
	 * Method perform a DELETE on the database, given a RoleAction or ::Criteria object OR a primary key value.
	 *
	 * @param      mixed $values ::Criteria or RoleAction object or primary key or array of primary keys
	 ...
	 */
	 ...
	 {
		if ($con === null) {
			$con = ::Propel::getConnection(RoleActionPeer::DATABASE_NAME);
		}
		...
		} elseif ($values instanceof RoleAction) {
	...
	/**
	 * Validates all modified columns of given RoleAction object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      RoleAction $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(RoleAction $obj, $cols = null)
	{
		$columns = array();
