...
abstract class BasePagePermission extends ::BaseObject  implements ::Persistent {
	...
	/**
	 * Initializes internal state of BasePagePermission object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PagePermission The current object (for fluent API support)
	 */
	public function setPageId($v)
	{
		...
		if ($this->page_id !== $v) {
			$this->page_id = $v;
			$this->modifiedColumns[] = PagePermissionPeer::PAGE_ID;
		}
	...
	public function setRoleId($v)
	{
		...
		if ($this->role_id !== $v) {
			$this->role_id = $v;
			$this->modifiedColumns[] = PagePermissionPeer::ROLE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PagePermissionPeer::NUM_COLUMNS - PagePermissionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		$stmt = PagePermissionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(::PropelPDO $con = null)
	{
		...
		try {
			...
			PagePermissionPeer::doDelete($this, $con);
	...
	public function save(::PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			PagePermissionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (::PropelException $e) {
			$con->rollback();
			throw $e;
	...
	protected function doSave(::PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PagePermissionPeer::doInsert($this, $con);
					...
					$affectedRows += PagePermissionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PagePermissionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PagePermissionPeer::translateFieldName($name, $type, ::BasePeer::TYPE_NUM);
	...
	{
		$keys = PagePermissionPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PagePermissionPeer::PAGE_ID)) $criteria->add(PagePermissionPeer::PAGE_ID, $this->page_id);
		if ($this->isColumnModified(PagePermissionPeer::ROLE_ID)) $criteria->add(PagePermissionPeer::ROLE_ID, $this->role_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PagePermissionPeer::PAGE_ID, $this->page_id);
		$criteria->add(PagePermissionPeer::ROLE_ID, $this->role_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PagePermission (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PagePermission Clone of current object.
	 * @throws     ::PropelException
	 */
	 ...
	 *
	 * @return     PagePermissionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PagePermissionPeer();
		}
		return self::$peer;
	}
