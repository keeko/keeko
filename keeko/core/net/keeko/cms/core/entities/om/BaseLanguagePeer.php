...
use net::keeko::cms::core::entities::map::LanguageMapBuilder;
...
abstract class BaseLanguagePeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.Language';
	...
	private static $fieldNames = array (
		::BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Country', 'Language', 'Variant', 'IsDefault', 'Url', ),
		::BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'country', 'language', 'variant', 'isDefault', 'url', ),
		::BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::COUNTRY, self::LANGUAGE, self::VARIANT, self::IS_DEFAULT, self::URL, ),
		::BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'country', 'language', 'variant', 'is_default', 'url', ),
	...
	private static $fieldKeys = array (
		::BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Country' => 2, 'Language' => 3, 'Variant' => 4, 'IsDefault' => 5, 'Url' => 6, ),
		::BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'country' => 2, 'language' => 3, 'variant' => 4, 'isDefault' => 5, 'url' => 6, ),
		::BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::COUNTRY => 2, self::LANGUAGE => 3, self::VARIANT => 4, self::IS_DEFAULT => 5, self::URL => 6, ),
		::BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'country' => 2, 'language' => 3, 'variant' => 4, 'is_default' => 5, 'url' => 6, ),
		::BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LanguageMapBuilder();
		}
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$stmt = LanguagePeer::doSelectStmt($criteria, $con);
	...
	protected static function doOnDeleteCascade(::Criteria $criteria, ::PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related LanguageText objects
			$c = new ::Criteria();
