...
/**
 * Base class that represents a row from the 'setting_cat' table.
 *
 * 
 *
 * @package    net.keeko.cms.core.entities.om
 */
abstract class BaseSettingCat extends ::BaseObject  implements ::Persistent {
	...
	/**
	 * Initializes internal state of BaseSettingCat object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     SettingCat The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SettingCatPeer::ID;
		}
	...
	public function setNameId($v)
	{
		...
		if ($this->name_id !== $v) {
			$this->name_id = $v;
			$this->modifiedColumns[] = SettingCatPeer::NAME_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = SettingCatPeer::NUM_COLUMNS - SettingCatPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new ::PropelException("Error populating SettingCat object", $e);
		}
	}
	...
	public function reload($deep = false, ::PropelPDO $con = null)
	{
		...
		$stmt = SettingCatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(::PropelPDO $con = null)
	{
		...
		try {
			...
			SettingCatPeer::doDelete($this, $con);
	...
	public function save(::PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			SettingCatPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (::PropelException $e) {
			$con->rollback();
			throw $e;
	...
	protected function doSave(::PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SettingCatPeer::doInsert($this, $con);
					...
					$affectedRows += SettingCatPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SettingCatPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SettingCatPeer::translateFieldName($name, $type, ::BasePeer::TYPE_NUM);
	...
	{
		$keys = SettingCatPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SettingCatPeer::ID)) $criteria->add(SettingCatPeer::ID, $this->id);
		if ($this->isColumnModified(SettingCatPeer::NAME_ID)) $criteria->add(SettingCatPeer::NAME_ID, $this->name_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SettingCatPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SettingCat (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SettingCat Clone of current object.
	 * @throws     ::PropelException
	 */
	 ...
	 *
	 * @return     SettingCatPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SettingCatPeer();
		}
		return self::$peer;
	}
	...
	public function getLanguageText(::PropelPDO $con = null)
	{
		if ($this->aLanguageText === null && ($this->name_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aLanguageText->addSettingCats($this);
			 */
		}
	 ...
	 * Otherwise if this SettingCat has previously been saved, it will retrieve
	 * related Settings from storage. If this SettingCat is new, it will return
		...
		if ($this->collSettings === null) {
			if ($this->isNew()) {
			   $this->collSettings = array();
				...
				$criteria->add(SettingPeer::CAT_ID, $this->getId());
	 ...
	 * Otherwise if this SettingCat is new, it will return
	 * an empty collection; or if this SettingCat has previously
	 * been saved, it will retrieve related Settings from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SettingCat.
	 */
