...
use net::keeko::cms::core::entities::Unit;
...
abstract class BaseUnitPeer {
	...
	const CLASS_DEFAULT = 'net.keeko.cms.core.entities.Unit';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new UnitMapBuilder();
		}
	...
	public static function doCount(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$stmt = UnitPeer::doSelectStmt($criteria, $con);
	...
	public static function doCountJoinGrid(::Criteria $criteria, $distinct = false, ::PropelPDO $con = null)
	{
		...
		$criteria->addJoin(UnitPeer::GRID_ID, GridPeer::ID, ::Criteria::LEFT_JOIN);
	...
	/**
	 * Selects a collection of Unit objects pre-filled with their Grid objects.
	 *
	...
	public static function doSelectJoinGrid(::Criteria $c, $con = null)
	{
		...
		$c->addJoin(UnitPeer::GRID_ID, GridPeer::ID, ::Criteria::LEFT_JOIN);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Unit) to $obj2 (Grid)
				$obj2->addUnit($obj1);
	...
	public static function doSelectJoinAll(::Criteria $c, $con = null)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Unit) to the collection in $obj2 (Grid)
				$obj2->addUnit($obj1);
