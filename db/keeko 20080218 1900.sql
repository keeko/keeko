...
INSERT INTO `menu_item` (`id`,`parent_id`,`menu_id`,`text_id`,`text_constant`,`page_id`,`module_id`,`action_id`,`event`,`image`) VALUES 
 (1,0,1,0,'start',NULL,1,1,1,''),
 (2,0,1,0,'page',NULL,NULL,NULL,1,NULL),
 (3,0,1,0,'user',NULL,NULL,NULL,1,NULL);
