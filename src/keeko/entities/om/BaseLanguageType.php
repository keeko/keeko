...
use keeko\entities\LanguageTypePeer;
...
abstract class BaseLanguageType extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'keeko\\entities\\LanguageTypePeer';
    ...
    {
        $this->languagesScheduledForDeletion = $this->getLanguages(new Criteria(), $con)->diff($languages);

        foreach ($this->languagesScheduledForDeletion as $languageRemoved) {
