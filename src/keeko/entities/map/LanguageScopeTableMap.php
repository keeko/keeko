...
class LanguageScopeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'keeko.entities.map.LanguageScopeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('keeko\\entities\\LanguageScope');
    ...
    {
        $this->addRelation('Language', 'keeko\\entities\\Language', RelationMap::ONE_TO_MANY, array('id' => 'scope_id', ), null, null, 'Languages');
    } // buildRelations()
